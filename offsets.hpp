...
// 2023-05-13 03:28:49.004423300 UTC

namespace offsets {
	constexpr ::std::int64_t timestamp = 1683948529;
	namespace netvars {
		...
		constexpr ::std::ptrdiff_t m_dwBoneMatrix = 0x26A8; // it will be a pointer to the bone structure, and from here we can get
		// the head bone which is 10, so, if i wanna get the head of all entities, i need to go here and add 0x10 or 10, idk
		...
		constexpr ::std::ptrdiff_t m_vecViewOffset = 0x108; // + vecOrigin is our eye offset
	...
	namespace signatures {
		...
		constexpr ::std::ptrdiff_t find_hud_element = 0x54A6F630;
